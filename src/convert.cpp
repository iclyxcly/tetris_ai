...
int main()
{
	...
	fprintf(out, "	}\n");
	fprintf(out, "	constexpr Offset cw_offset[7][4][8] = {\n");
	...
	fprintf(out, "		{{{%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}},\n", j_mino.rot(0).cw(0).x, j_mino.rot(0).cw(0).y, j_mino.rot(0).cw(1).x, j_mino.rot(0).cw(1).y, j_mino.rot(0).cw(2).x, j_mino.rot(0).cw(2).y, j_mino.rot(0).cw(3).x, j_mino.rot(0).cw(3).y, j_mino.rot(0).cw(4).x, j_mino.rot(0).cw(4).y, j_mino.rot(0).cw(5).x, j_mino.rot(0).cw(5).y, j_mino.rot(0).cw(6).x, j_mino.rot(0).cw(6).y, j_mino.rot(0).cw(7).x, j_mino.rot(0).cw(7).y);
	fprintf(out, "		{{%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}},\n", j_mino.rot(1).cw(0).x, j_mino.rot(1).cw(0).y, j_mino.rot(1).cw(1).x, j_mino.rot(1).cw(1).y, j_mino.rot(1).cw(2).x, j_mino.rot(1).cw(2).y, j_mino.rot(1).cw(3).x, j_mino.rot(1).cw(3).y, j_mino.rot(1).cw(4).x, j_mino.rot(1).cw(4).y, j_mino.rot(1).cw(5).x, j_mino.rot(1).cw(5).y, j_mino.rot(1).cw(6).x, j_mino.rot(1).cw(6).y, j_mino.rot(1).cw(7).x, j_mino.rot(1).cw(7).y);
	fprintf(out, "		{{%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}},\n", j_mino.rot(2).cw(0).x, j_mino.rot(2).cw(0).y, j_mino.rot(2).cw(1).x, j_mino.rot(2).cw(1).y, j_mino.rot(2).cw(2).x, j_mino.rot(2).cw(2).y, j_mino.rot(2).cw(3).x, j_mino.rot(2).cw(3).y, j_mino.rot(2).cw(4).x, j_mino.rot(2).cw(4).y, j_mino.rot(2).cw(5).x, j_mino.rot(2).cw(5).y, j_mino.rot(2).cw(6).x, j_mino.rot(2).cw(6).y, j_mino.rot(2).cw(7).x, j_mino.rot(2).cw(7).y);
	fprintf(out, "		{{%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}}},\n", j_mino.rot(3).cw(0).x, j_mino.rot(3).cw(0).y, j_mino.rot(3).cw(1).x, j_mino.rot(3).cw(1).y, j_mino.rot(3).cw(2).x, j_mino.rot(3).cw(2).y, j_mino.rot(3).cw(3).x, j_mino.rot(3).cw(3).y, j_mino.rot(3).cw(4).x, j_mino.rot(3).cw(4).y, j_mino.rot(3).cw(5).x, j_mino.rot(3).cw(5).y, j_mino.rot(3).cw(6).x, j_mino.rot(3).cw(6).y, j_mino.rot(3).cw(7).x, j_mino.rot(3).cw(7).y);
	fprintf(out, "	};\n");
	fprintf(out, "	constexpr Offset ccw_offset[7][4][8] = {\n");
	...
	fprintf(out, "		{{{%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}},\n", j_mino.rot(0).ccw(0).x, j_mino.rot(0).ccw(0).y, j_mino.rot(0).ccw(1).x, j_mino.rot(0).ccw(1).y, j_mino.rot(0).ccw(2).x, j_mino.rot(0).ccw(2).y, j_mino.rot(0).ccw(3).x, j_mino.rot(0).ccw(3).y, j_mino.rot(0).ccw(4).x, j_mino.rot(0).ccw(4).y, j_mino.rot(0).ccw(5).x, j_mino.rot(0).ccw(5).y, j_mino.rot(0).ccw(6).x, j_mino.rot(0).ccw(6).y, j_mino.rot(0).ccw(7).x, j_mino.rot(0).ccw(7).y);
	fprintf(out, "		{{%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}},\n", j_mino.rot(1).ccw(0).x, j_mino.rot(1).ccw(0).y, j_mino.rot(1).ccw(1).x, j_mino.rot(1).ccw(1).y, j_mino.rot(1).ccw(2).x, j_mino.rot(1).ccw(2).y, j_mino.rot(1).ccw(3).x, j_mino.rot(1).ccw(3).y, j_mino.rot(1).ccw(4).x, j_mino.rot(1).ccw(4).y, j_mino.rot(1).ccw(5).x, j_mino.rot(1).ccw(5).y, j_mino.rot(1).ccw(6).x, j_mino.rot(1).ccw(6).y, j_mino.rot(1).ccw(7).x, j_mino.rot(1).ccw(7).y);
	fprintf(out, "		{{%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}},\n", j_mino.rot(2).ccw(0).x, j_mino.rot(2).ccw(0).y, j_mino.rot(2).ccw(1).x, j_mino.rot(2).ccw(1).y, j_mino.rot(2).ccw(2).x, j_mino.rot(2).ccw(2).y, j_mino.rot(2).ccw(3).x, j_mino.rot(2).ccw(3).y, j_mino.rot(2).ccw(4).x, j_mino.rot(2).ccw(4).y, j_mino.rot(2).ccw(5).x, j_mino.rot(2).ccw(5).y, j_mino.rot(2).ccw(6).x, j_mino.rot(2).ccw(6).y, j_mino.rot(2).ccw(7).x, j_mino.rot(2).ccw(7).y);
	fprintf(out, "		{{%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}}},\n", j_mino.rot(3).ccw(0).x, j_mino.rot(3).ccw(0).y, j_mino.rot(3).ccw(1).x, j_mino.rot(3).ccw(1).y, j_mino.rot(3).ccw(2).x, j_mino.rot(3).ccw(2).y, j_mino.rot(3).ccw(3).x, j_mino.rot(3).ccw(3).y, j_mino.rot(3).ccw(4).x, j_mino.rot(3).ccw(4).y, j_mino.rot(3).ccw(5).x, j_mino.rot(3).ccw(5).y, j_mino.rot(3).ccw(6).x, j_mino.rot(3).ccw(6).y, j_mino.rot(3).ccw(7).x, j_mino.rot(3).ccw(7).y);
	fprintf(out, "	};\n");
	fprintf(out, "	constexpr Offset _180_offset[7][4][8] = {\n");
	...
	fprintf(out, "		{{{%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}},\n", j_mino.rot(0)._180(0).x, j_mino.rot(0)._180(0).y, j_mino.rot(0)._180(1).x, j_mino.rot(0)._180(1).y, j_mino.rot(0)._180(2).x, j_mino.rot(0)._180(2).y, j_mino.rot(0)._180(3).x, j_mino.rot(0)._180(3).y, j_mino.rot(0)._180(4).x, j_mino.rot(0)._180(4).y, j_mino.rot(0)._180(5).x, j_mino.rot(0)._180(5).y, j_mino.rot(0)._180(6).x, j_mino.rot(0)._180(6).y, j_mino.rot(0)._180(7).x, j_mino.rot(0)._180(7).y);
	fprintf(out, "		{{%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}},\n", j_mino.rot(1)._180(0).x, j_mino.rot(1)._180(0).y, j_mino.rot(1)._180(1).x, j_mino.rot(1)._180(1).y, j_mino.rot(1)._180(2).x, j_mino.rot(1)._180(2).y, j_mino.rot(1)._180(3).x, j_mino.rot(1)._180(3).y, j_mino.rot(1)._180(4).x, j_mino.rot(1)._180(4).y, j_mino.rot(1)._180(5).x, j_mino.rot(1)._180(5).y, j_mino.rot(1)._180(6).x, j_mino.rot(1)._180(6).y, j_mino.rot(1)._180(7).x, j_mino.rot(1)._180(7).y);
	fprintf(out, "		{{%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}},\n", j_mino.rot(2)._180(0).x, j_mino.rot(2)._180(0).y, j_mino.rot(2)._180(1).x, j_mino.rot(2)._180(1).y, j_mino.rot(2)._180(2).x, j_mino.rot(2)._180(2).y, j_mino.rot(2)._180(3).x, j_mino.rot(2)._180(3).y, j_mino.rot(2)._180(4).x, j_mino.rot(2)._180(4).y, j_mino.rot(2)._180(5).x, j_mino.rot(2)._180(5).y, j_mino.rot(2)._180(6).x, j_mino.rot(2)._180(6).y, j_mino.rot(2)._180(7).x, j_mino.rot(2)._180(7).y);
	fprintf(out, "		{{%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}, {%d, %d}}},\n", j_mino.rot(3)._180(0).x, j_mino.rot(3)._180(0).y, j_mino.rot(3)._180(1).x, j_mino.rot(3)._180(1).y, j_mino.rot(3)._180(2).x, j_mino.rot(3)._180(2).y, j_mino.rot(3)._180(3).x, j_mino.rot(3)._180(3).y, j_mino.rot(3)._180(4).x, j_mino.rot(3)._180(4).y, j_mino.rot(3)._180(5).x, j_mino.rot(3)._180(5).y, j_mino.rot(3)._180(6).x, j_mino.rot(3)._180(6).y, j_mino.rot(3)._180(7).x, j_mino.rot(3)._180(7).y);
	fprintf(out, "	};\n");
	fprintf(out, "	inline constexpr const Offset *clockwise(int m, int r) {\n");
	fprintf(out, "		return cw_offset[m][r];\n");
	fprintf(out, "	}\n");
	fprintf(out, "	inline constexpr const Offset *counterclockwise(int m, int r) {\n");
	fprintf(out, "		return ccw_offset[m][r];\n");
	fprintf(out, "	}\n");
	fprintf(out, "	inline constexpr const Offset *_180_spin(int m, int r) {\n");
